    ...
    <div id="content-1" class="mt-4">
      <div class="container">
        <div class="row justify-content-center mt-5">
          <div class="col-md-4">
            <h2 class="text-center mb-4">CADASTRAR TIPO ATENDIMENTO</h2>
            <section>
              <form method="POST" action="processa-tipo.php" id="cadastroTipoForm" class="mt-3">
                <div class="mb-3">
                  <label for="tipo" class="form-label mb-0">Tipo Atendimento</label>
                  <input type="text" id="tipo" name="tipo" class="form-control dark-border" onkeyup="maiusc(this)">
                </div>
